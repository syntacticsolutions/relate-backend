...
INSERT INTO users (role_id, uid, email, first_name, last_name)
VALUES
(1, 'f0a9s70a9s7df987asd','mcoder@lavishweb.com', 'Miguel', 'Coder'),
(2, '0a98s7d0fa87s9d087','dummy@person.com', 'Dummy', 'Person');
